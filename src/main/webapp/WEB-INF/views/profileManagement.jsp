                  ...
                  <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-group col-md-12">
                              ...
                              <div class="col-md-7">
                                 <input type="date" id="birthDate" name="input" ng-model="ctrl.profile.birthDate" min="1930-01-01" max="2015-12-31" value="{{ date | date: 'yyyy-MM-dd' }}" />
                                  <div class="has-error" ng-show="myForm.$dirty">
                  ...
                  <table class="table table-hover">
                      ...
                      <tbody>
                          <tr ng-repeat="u in ctrl.profiles">
                              ...
                              <td><span> {{u.birthDate | date:'medium'}}</span></td>
