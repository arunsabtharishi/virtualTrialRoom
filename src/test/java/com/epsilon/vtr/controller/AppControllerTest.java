...
public class AppControllerTest {
    ...
    public void setUp(){
        ...
        employeeVOList = transferTo(employees);
    }
   ...
   /* @Test
    public void listEmployees(){
        ...
        Assert.assertEquals(model.get("employees"), employeeVOList);
    ...
    public void newEmployee(){
        ...
        Assert.assertEquals(((EmployeeVO)model.get("employee")).getId(), 0);
    }
    ...
    */
    ...
    public List<EmployeeVO> transferTo(List<Employee> employees) {
